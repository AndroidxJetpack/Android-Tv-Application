...
public class LogoutFragment extends Fragment {
     ...
     *
     * @param lastFragment Parameter 1.
     * @param param2 Parameter 2.
     * @return A new instance of fragment LogoutFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static LogoutFragment newInstance(String lastFragment, String param2) {
        LogoutFragment fragment = new LogoutFragment();
        Bundle args = new Bundle();
        args.putString(ARG_PARAM1, lastFragment);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            lastFragment = getArguments().getString(ARG_PARAM1);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mBtnCancel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               getActivity().getSupportFragmentManager().popBackStack();
                navigationMenuCallback.selectedOption(lastFragment);
            }
        });
        mBtnOK.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TokenStorage.clearSharedToken(getContext());
